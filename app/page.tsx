                        ...
                        <div className="mb-20">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                ...
                                <div className="bg-muted/30 p-6 rounded-lg border">
                                    ...
                                    <p className="text-muted-foreground">Select from available lending pools or create your own with custom parameters.</p>
                                </div>
                                <div className="bg-muted/30 p-6 rounded-lg border">
                                    <div className="bg-primary text-primary-foreground w-8 h-8 rounded-full flex items-center justify-center font-bold mb-4">3</div>
                                    <h3 className="text-lg font-semibold mb-2">Supply or Trade</h3>
                                    <p className="text-muted-foreground">Supply assets to earn interest or open leveraged trading positions.</p>
                                </div>
                                <div className="bg-muted/30 p-6 rounded-lg border">
                                    ...
                                    <p className="text-muted-foreground">Adjust your positions, add collateral, or close positions to realize profits.</p>
                                </div>
                            </div>
                        </div>
                    </>
