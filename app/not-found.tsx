      ...
      <div className='container flex flex-col items-center justify-center min-h-[80vh] px-4 lg:px-16'>
        <div className='text-center space-y-6'>
          ...
          <p className='text-muted-foreground text-lg max-w-md mx-auto'>
            Sorry, we couldn&apos;t find the page you&apos;re looking for. Please check the URL or go back to the
            homepage.
          </p>
          ...
          <div className='flex flex-col sm:flex-row justify-center gap-4 pt-4'>
            ...
            <Button variant='default' size='lg' onClick={() => router.push('/')} className='gap-2'>
