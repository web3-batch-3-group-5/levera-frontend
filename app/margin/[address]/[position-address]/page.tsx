...
export default function PositionDetailsPage() {
    ...
    const handleAdjustLeverage = () => {
        if (!positionAddress) return;
        router.push(
            `/margin/${poolAddress}/${positionAddress}/adjust-leverage`
        );
    };
                    ...
                    <div className='bg-card rounded-lg border p-6'>
                        <div className='text-center py-8'>
                            ...
                            <p className='text-muted-foreground mb-6'>
                                The position address appears to be invalid or
                                cannot be processed.
                                <br />
                                <code className='block mt-2 p-2 bg-muted rounded text-xs'>
                                    Raw Position Address:{' '}
                                    {params?.['position-address']?.toString() ||
                                        'undefined'}
                                </code>
                            </p>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-4 my-6'>
                    <div className='bg-muted/50 p-4 rounded-lg border'>
                        ...
                        <p className='text-xl font-semibold'>
                            {formattedValues.baseCollateral}{' '}
                    ...
                    <div className='mt-6 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg p-4 flex items-start gap-3'>
                        ...
                        <div>
                            ...
                            <p className='text-sm text-amber-700 dark:text-amber-400'>
                                This position has a low health factor and may be
                                at risk of liquidation. Consider adding more
                                collateral or reducing leverage.
                            </p>
                        </div>
                    </div>
                )}
