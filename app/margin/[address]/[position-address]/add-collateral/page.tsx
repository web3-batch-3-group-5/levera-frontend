                ...
                <div className="bg-card rounded-lg border p-6 space-y-6">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Add collateral to your {pool?.loanTokenSymbol}/{pool?.collateralTokenSymbol} position to improve health factor
                        </p>
                    </div>
                    ...
                    {isClient && collateralAmount && Number(collateralAmount) > 0 && (
                        <div className="bg-muted/50 rounded-lg p-4 space-y-3">
                            <div className="flex justify-between">
                                ...
                                <span>{parseFloat(formatUnits(baseCollateral || 0n, 18)) + parseFloat(collateralAmount)} {pool?.collateralTokenSymbol}</span>
                            </div>
                            <div className="flex justify-between">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span>
                                    ...
                                    {updatedMetrics.liquidationPriceReduction > 0 && (
                                        <span className="text-green-500 ml-1">(-{updatedMetrics.liquidationPriceReduction.toFixed(6)})</span>
                                    )}
                                </span>
                            </div>
                        </div>
