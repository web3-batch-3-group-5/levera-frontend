                ...
                <div className="bg-card rounded-lg border p-6 space-y-6">
                    ...
                    <div className="bg-muted/50 rounded-lg p-4 space-y-3">
                        ...
                        <div className="flex justify-between">
                            ...
                            <span>{formatTokenAmount(baseCollateral || 0n)} {pool.collateralTokenSymbol}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-sm text-muted-foreground">Effective Collateral</span>
                            <span>{formatTokenAmount(effectiveCollateral || 0n)} {pool.collateralTokenSymbol}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-sm text-muted-foreground">Borrowed Amount</span>
                            <span>{formatTokenAmount(borrowShares || 0n)} {pool.loanTokenSymbol}</span>
                        </div>
                        <div className="flex justify-between">
