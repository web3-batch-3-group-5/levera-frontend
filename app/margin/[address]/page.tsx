                        ...
                        <h1 className='text-3xl font-bold'>
                            {isLoading ? (
                                ...
                                <>
                                    ...
                                    {pool?.collateralTokenSymbol} Trading Pool
                                </>
                            )}
                        </h1>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-sm text-muted-foreground'>
                                            ...
                                            {pool.liquidationThresholdPercentage
                                                ...
                                                : '0'}
                                            % liquidation threshold. Positions
                                            are{' '}
                                            {pool.positionType === 0
                                                ? 'LONG'
                                                : 'SHORT'}
                                            , meaning you'll profit when
                                            {pool.positionType === 0
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                        <div>
                            ...
                            <p className='text-sm text-muted-foreground mb-2'>
                                Leverage allows you to multiply your exposure to
                                price movements by borrowing assets from the
                                lending pool. For example, with 2x leverage:
                            </p>
                            <ul className='list-disc list-inside text-sm text-muted-foreground space-y-1 pl-2'>
                                <li>
                                    If the market moves 10% in your favor, your
                                    returns are ~20%
                                </li>
                                <li>
                                    If the market moves 10% against you, your
                                    losses are ~20%
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <p className='text-sm text-muted-foreground mb-2'>
                                Higher leverage means higher risk of
                                liquidation. Your position will be liquidated
                                if:
                            </p>
                            <ul className='list-disc list-inside text-sm text-muted-foreground space-y-1 pl-2'>
                                <li>Your health factor drops below 1.0</li>
                                <li>
                                    The market price reaches your liquidation
                                    price
                                </li>
                                <li>
                                    Always monitor your positions and add
                    ...
                    <div className='mt-4 p-3 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg'>
                        <div className='flex items-start gap-2'>
                            ...
                            <p className='text-sm text-blue-700 dark:text-blue-300'>
                                For this pool, the maximum leverage is 3x.
                                Higher leverage means higher returns but also
                                higher risk. Start with lower leverage if you're
                                new to margin trading.
                            </p>
                        </div>
                    </div>
