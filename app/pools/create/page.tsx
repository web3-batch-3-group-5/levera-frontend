...
export default function CreatePoolPage() {
  ...
  const validateAddresses = (data: FormData): boolean => {
    const isValidAddress = (address: string) => address.startsWith('0x') && address.length === 42;
        ...
        <div className='bg-card rounded-lg border p-6 space-y-6'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            <div className='space-y-4'>
              <div>
                <label className='block text-sm font-medium mb-2'>Loan Token Address</label>
                <input
                  type='text'
                  name='loanToken'
                  ...
                  disabled={isPending || isConfirming}
                />
                <p className='text-xs text-muted-foreground mt-1'>The token that will be supplied and borrowed</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  disabled={isPending || isConfirming}
                />
                <p className='text-xs text-muted-foreground mt-1'>The token that will be used as collateral</p>
              </div>

              <div>
                <label className='block text-sm font-medium mb-2'>Loan Token Price Feed</label>
                <input
                  type='text'
                  ...
                  disabled={isPending || isConfirming}
                />
                <p className='text-xs text-muted-foreground mt-1'>Chainlink price feed address for the loan token</p>
              </div>

              <div>
                <label className='block text-sm font-medium mb-2'>Collateral Token Price Feed</label>
                <input
                  type='text'
              ...
              <div>
                <div className='flex justify-between items-center mb-2'>
                  <label className='block text-sm font-medium'>Liquidation Threshold (%)</label>
              ...
              <div>
                ...
                <p className='text-xs text-muted-foreground mt-1'>The type of position this pool supports</p>
              </div>
            </div>
              ...
              <div className='flex items-start gap-2'>
                ...
                <div>
                  ...
                  <p className='text-muted-foreground text-xs'>
                    Make sure you&apos;ve verified the token addresses and price feeds. Once created, pool parameters
                    cannot be changed.
                  </p>
                </div>
              </div>
