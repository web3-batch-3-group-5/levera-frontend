...
export default function WithdrawPage() {
  ...
  const { userSupplyShares, totalSupplyAssets, totalSupplyShares, totalBorrowAssets, interestRate } =
  ...
  const assetsLeftAfterWithdrawal =
    availableWithdrawal && amount ? availableWithdrawal - (parseUnits(amount, 18) || 0n) : availableWithdrawal;
  ...
  const supplyAPY = interestRate ? Number(interestRate) * (utilizationRate / 100) : 0;
    ...
    <main className='container mx-auto px-4 py-8'>
      ...
      <div className='max-w-xl mx-auto'>
        <div className='bg-card rounded-lg border p-6 space-y-6'>
          <div>
            <h1 className='text-2xl font-bold mb-2 px-2'>Withdraw {pool.loanTokenSymbol}</h1>
            <p className='text-sm text-muted-foreground px-2'>
              Withdraw your supplied {pool.loanTokenSymbol} from the {pool.loanTokenSymbol}/{pool.collateralTokenSymbol}{' '}
              pool
            </p>
          </div>
          ...
          <div className='space-y-4'>
            ...
            <div className='bg-muted/50 rounded-lg p-4 space-y-3'>
              ...
              <div className='flex justify-between items-center'>
                ...
                <div className='font-medium text-green-600'>{formatPercentage(supplyAPY)}</div>
              </div>
